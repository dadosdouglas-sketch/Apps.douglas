...
export const FaTruckMoving = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="4" y="3" width="12" height="13"></rect>
    <polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon>
    <circle cx="8.5" cy="18.5" r="2.5"></circle>
    <circle cx="19.5" cy="18.5" r="2.5"></circle>
    <path d="M0 8h2.5"></path>
    <path d="M0 11h2.5"></path>
    <path d="M1 5h2"></path>
  </svg>
);

export const FastTruckIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M14 16H9m-5 0H3m8-11H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h.5M19 9h2a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-1M11 5h6a2 2 0 0 1 2 2v2h-8" />
    <circle cx="6.5" cy="17.5" r="2.5" />
    <circle cx="16.5" cy="17.5" r="2.5" />
    <path d="M2 8h3m-3 3h5m-5 3h2" />
  </svg>
);
...
export const TruckIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M15 8h4a2 2 0 0 1 2 2v5h-2" />
    <path d="M15 15h-2" />
...
export const AxleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="3" y="6" width="4" height="12" rx="1"></rect>
    <path d="M5 6v12"></path>
    <path d="M3 8h4"></path>
    <path d="M3 16h4"></path>
    <rect x="17" y="6" width="4" height="12" rx="1"></rect>
    <path d="M19 6v12"></path>
    <path d="M17 8h4"></path>
    <path d="M17 16h4"></path>
    <path d="M7 12h3"></path>
    <path d="M14 12h3"></path>
    <path d="M10 12c0 1.5 1 2 2 2s2-.5 2-2"></path>
    <path d="M10 12c0-1.5 1-2 2-2s2 .5 2 2"></path>
...
export const SlackAdjusterIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    {/* Arm */}
    <path d="M13 12l-7 8a2 2 0 0 1-2.5-2.5l8-7" />
    {/* Connection Hole */}
    <circle cx="5" cy="19" r="1.5" />
    {/* Adjuster Mechanism */}
    <rect x="11" y="3" width="3" height="4" rx="1" transform="rotate(-30 12.5 5)" />
    <path d="M11 8.5L9 6.5" />
  </svg>
);
...
export const BrakeDiscIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M4.6 12A7.4 7.4 0 0 1 12 4.6V2a10 10 0 0 0-10 10h2.6z" />
...
export const MoonStarsIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
    <path d="M12 2v2" strokeWidth="1"></path>
    <path d="M19 8h2" strokeWidth="1"></path>
  </svg>
);
...
export const CartPlusIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="9" cy="21" r="1"></circle>
    <circle cx="20" cy="21" r="1"></circle>
    <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
